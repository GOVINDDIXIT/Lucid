...
class AbstractWork extends StatefulWidget {
  @override
  AbstractWorkState createState() => AbstractWorkState();
}

class AbstractWorkState extends State<AbstractWork> {
  ...
  final CollectionReference collectionReference =
      Firestore.instance.collection("abstract");
